...
export const stages = [
  ["Inscrições", "12", "Novas entradas"],
  ["Em análise", "08", "Revisão da equipe"],
  ["Documentos", "05", "Aguardando envio"],
  ["Contratos", "04", "Em preparação"],
  ["Ativos", "22", "Afiliados vigentes"],
];

export const affiliateFilters = ["Todos", "Em análise", "Pendências", "Ativos"];